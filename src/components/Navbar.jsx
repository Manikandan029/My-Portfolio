...
{isOpen && (
    <div className="fixed top-16 left-0 right-0 bg-gradient-to-r from-bg-white/30 to-gray-700 text-white flex flex-col items-center py-6 space-y-4 text-xl rounded-xl shadow-2xl  border-gray-600 backdrop-blur-lg bg-opacity-90 transition-all duration-300 animate-slideDown z-[1000] border-2">
